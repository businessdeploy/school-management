...
<script>
    ...
    get_student_parent_chat_msg_count();
    setInterval(get_student_parent_chat_msg_count,15000);
    function get_student_parent_chat_msg_count(){
        $.ajax({
            type: "POST",
            url: base_url+ 'user/chat/get_student_parent_chat_msg_count',
            dataType: "JSON",
            data: { },
            success: function (data) {
